...
public class MapGraph {
	...
	public void addEdge(GeographicPoint from, GeographicPoint to, String roadName,
		...
		GeoEdge ge = new GeoEdge(from, to, roadName, roadType, length);
		this.roadEdges.add(ge);
		
		ge.setFromVertex(fromVert);
		ge.setToVertex(toVert);
		toVert.addEdge(ge);
		fromVert.addEdge(ge);
		}
	}
	 ...
	 * If BFS search finds a path, then this method is called to conver the parent map we have constructed and 
			 					     ...
			 					     GeographicPoint goal, Consumer<GeographicPoint> nodeSearched)
	{
		...
		//Step 1: Initial searchQueue and visited Vertices
		...
		//implement parent map to list conversion
